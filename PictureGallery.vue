        ...
        <div class="Picture-Gallery-box" v-show="GalleryIsShow">
            ...
            <div :class="[GallerPreviewIsShow ? 'Picture-Gallery-preview-box-isShow' : 'Picture-Gallery-preview-box-unShow']" class="Picture-Gallery-preview-box">
                ...
                <div class="Picture-Gallery-select-item-box flex-box">
                    <template v-for="item in PictureObjectArr">
                        <div @click="PictureChange(item.id)"  :class="{'Picture-Gallery-select-item-box-isActive' : item.isShow}" :key="item.id">
            ...
            PictureArrInit:function () {
                this.PictureArr.forEach((item,index)=>{
                    ...
                    if (typeof item === 'object'){
                        about['title'] = item['title'] ? item['title'] : 'Title'
                        about['info'] = item['info'] ? item['info'] : 'Lorem Ipsum is simply dummy text of the printing.'
                        object['about'] = about
                        ...
                        object['Picture'] = item
                        about['title'] = 'Title'
                        about['info'] = 'Lorem Ipsum is simply dummy text of the printing.'
                        object['about'] = about
                    }
                    object['id'] = index
                    object['isShow'] = false
                ...
                console.log(this.PictureObjectArr)
            },
